...
const Project = () => {
    return (
        <Layout title="Paranoia">
            <Head>
                <title>Shinno's Portfolio Page | Projects - Paranoia</title>
                <meta
                    name="description"
            ...
            <Container>
                ...
                <P>
                    As a developer, I am immensely proud of "Paranoia" as it
                    represents the perfect marriage of my passion for web
                    ...
                    intricacies of "Paranoia" on my portfolio website, and join
                    me on this journey towards a more secure online experience.
                </P>
                <List ml={4} my={4}>
                    <ListItem>
                        <Meta>Website</Meta>
